...
export const APIGetBlogDetail = (blogId: string) =>
...
export const APIEditBlog = (data: any, blogId: string) => PutRequest(`/blogs/${blogId}`, data)

export const APIChangeBlogStatus = (blogId: string, isActive: Boolean) =>
    PatchRequest(`/blogs/${blogId}`, {
        activate: isActive,
    })
export const APIRemoveBlog = (blogId: string) =>
